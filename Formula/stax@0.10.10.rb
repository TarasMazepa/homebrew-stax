class StaxAT01010 < Formula
  ...
  if OS.mac? && Hardware::CPU.intel?
    ...
    sha256 '2ebbdebc6136dd59850580d6b27758811a0c92da8eaeab2571e0ca9ac26a53a3' # macos-x64
  elsif OS.mac? && Hardware::CPU.arm?
    url "https://github.com/TarasMazepa/stax/releases/download/#{version}/macos-arm.zip"
    sha256 '2b184004bac4de999037d30c44a6e4c5fde47e409b2fccaf67edd226d2617a17' # macos-arm
  elsif OS.linux? && Hardware::CPU.intel? && Hardware::CPU.is_64_bit?
    url "https://github.com/TarasMazepa/stax/releases/download/#{version}/linux-x64.zip"
    sha256 '3ad6deb0d397f35afdc3e671a8827ff9c501613d0f4c4946799e7629ed261965' # linux-x64
  else

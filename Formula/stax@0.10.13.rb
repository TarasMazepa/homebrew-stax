class StaxAT01013 < Formula
  ...
  if OS.mac? && Hardware::CPU.intel?
    ...
    sha256 '358132c9ec1d4b99dde434dc6d073e2727e0e644e0915851e9cbd7771f23f83d' # macos-x64
  elsif OS.mac? && Hardware::CPU.arm?
    url "https://github.com/TarasMazepa/stax/releases/download/#{version}/macos-arm.zip"
    sha256 '0dabd6fae33ec482ced0c03a5dd40fb61495ce96f76826b9512d6f3cdf0ff789' # macos-arm
  elsif OS.linux? && Hardware::CPU.intel? && Hardware::CPU.is_64_bit?
    url "https://github.com/TarasMazepa/stax/releases/download/#{version}/linux-x64.zip"
    sha256 '1f0190c4aee23931076db04699cff4226e38910ca6511b52b1f6cc6389bdf9a6' # linux-x64
  else

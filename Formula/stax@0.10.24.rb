class StaxAT01024 < Formula
  ...
  if OS.mac? && Hardware::CPU.intel?
    ...
    sha256 'dd2499c7afe9b34bd944f6d1a104e067832e7413b574eeab5cafe407767e73d3' # macos-arm
  elsif OS.linux? && Hardware::CPU.intel? && Hardware::CPU.is_64_bit?
    url "https://github.com/TarasMazepa/stax/releases/download/#{version}/linux-x64.zip"
    sha256 'b221f85ee327c47a4542406a5a518f91bf68aaade77f09686f3a0976d178f108' # linux-x64
  else

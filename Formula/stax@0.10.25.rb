class StaxAT01025 < Formula
  ...
  if OS.mac? && Hardware::CPU.intel?
    ...
    sha256 '418cdbbb1208a84e0677c32ca7a504a3422060e32e9fdf393f08831dcac8c81f' # macos-arm
  elsif OS.linux? && Hardware::CPU.intel? && Hardware::CPU.is_64_bit?
    url "https://github.com/TarasMazepa/stax/releases/download/#{version}/linux-x64.zip"
    sha256 '497fe52dbf96daff5e51068d233efd70b271925cb41e95c712265b8fb53ed511' # linux-x64
  else

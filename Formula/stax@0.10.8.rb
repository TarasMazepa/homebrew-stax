class StaxAT0108 < Formula
  ...
  if OS.mac? && Hardware::CPU.intel?
    ...
    sha256 'a086e9edb75dcd34c510416db883424ddf7fe72b883514901440c27153cef4b9' # macos-x64
  elsif OS.mac? && Hardware::CPU.arm?
    url "https://github.com/TarasMazepa/stax/releases/download/#{version}/macos-arm.zip"
    sha256 'a2e6b99a6b22cc1df20babc04e274800a734aa6aeb0ba2be10320071d339fef9' # macos-arm
  elsif OS.linux? && Hardware::CPU.intel? && Hardware::CPU.is_64_bit?
    url "https://github.com/TarasMazepa/stax/releases/download/#{version}/linux-x64.zip"
    sha256 'dc65656e1acec0e67a16bb98cc932db8a75002c70a1c7acd1c819127feda8658' # linux-x64
  else

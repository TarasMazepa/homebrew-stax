class StaxAT0118 < Formula
  ...
  if OS.mac? && Hardware::CPU.arm?
    ...
    sha256 '6cfc926d7d36d0c5da61e300367cef4ec0e35247c29efaf749be8732983382c4' # macos-arm
  elsif OS.linux? && Hardware::CPU.intel? && Hardware::CPU.is_64_bit?
    url "https://github.com/TarasMazepa/stax/releases/download/#{version}/linux-x64.zip"
    sha256 '397c21737a2534534e62001bbbf250ed1eb69cd77b7fed866fdacae1d9ed1a03' # linux-x64
  else

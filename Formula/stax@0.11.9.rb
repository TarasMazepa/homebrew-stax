class StaxAT0119 < Formula
  ...
  if OS.mac? && Hardware::CPU.arm?
    ...
    sha256 '59cd43f29faecba8ce029641666b7705e1cd36483e70551907a8131a4022c52d' # macos-arm
  elsif OS.linux? && Hardware::CPU.intel? && Hardware::CPU.is_64_bit?
    url "https://github.com/TarasMazepa/stax/releases/download/#{version}/linux-x64.zip"
    sha256 'ded2ae4242c010ebbe02e81f27c7754918be89a788aebb221f783191afa82063' # linux-x64
  else
